...
const CREATE_HOUSE = gql`
  mutation AddPropiedad($data: addPropiedades!) {
    addPropiedades(data: $data) {
      _id
      nombre
    }
  }
...
class FormPropiedad extends Component {
  ...
  onFormSubmit = (event, addPropiedad) => {
    ...
    addPropiedad({ variables: { data: this.state } });
        ...
        {(addPropiedad, { data }) => (
          <div className="row justify-content-center">
            <form onSubmit={e => this.onFormSubmit(e, addPropiedad)}>
              ...
              <Calendar
                onChange={value =>
                  this.checkCalendarInput('disponibilidad_inicial', value)
                }
              ...
              <Calendar
                onChange={value =>
                  this.checkCalendarInput('disponibilidad_final', value)
                }
